...
import '../assets/styles/home.css';  // Importa el archivo CSS
  ...
  return (
    <div className="home-container">
      ...
      <div className="card-grid">
        <CardTicket
          ticket="Huespedes"
          totalTickets="Nhuespedes"
          text="cantidad de huespedes"
          Linkpagina="/huespedes"
        />
        <CardTicket
          ticket="habitaciones"
          totalTickets="habitaciones disponibles"
          text="X"
          Linkpagina="/habitaciones"
        />
        <CardTicket
          ticket="Inventario"
          totalTickets=""
        ...
        <CardTicket
          ...
          totalTickets="10"
          text="solicitudes"
          Linkpagina="/solicitudes"
        />
      </div>
      <div>
        <h1 className="title">Solicitudes o notificaciones de algo</h1>
      </div>
